...
function Descriptionn() {
    ...
    return(
        <section className=" border-r border-slate-400 shadow-sm fixed top-0 w-96 lg:min-h-screen md:min-h-0 sm:min-h-0 min-h-0">
            <div className="flex flex-col items-center justify-center pt-8">
                <img src={new URL("../../assets/img/fotoprogra.jpg", import.meta.url).href} alt="profile" className="object-cover w-52 h-54 rounded-full shadow-lg"/>
            ...
            <article className="mr-4 ml-4 mt-9 flex flex-col">
                <p className="text-slate-300">
                   I am a full stack developer with a stronger passion for frontend development, although I also have knowledge in backend, especially in Node.js. I'm ready to jump in and bring my skills to a team or work environment. Always learning and keeping up with the latest tech trends to stay sharp.
                </p>
                <NavLink to="/contact" className="bg-yellow-400 rounded-md w-full h-11 font-semibold mt-5 flex justify-center items-center hover:scale-105 transition-transform duration-300 hover:font-bold">
                    Contact me
                </NavLink>
            </article>
            ...
            <aside className="text-white flex justify-center gap-9 mt-8 ">
                {/* Redes sociales */}
                <a href="https://github.com/Elitaxh06" target="_blank" className="w-11 hover:scale-110 transition-transform duration-300">
                ...
                <a href="https://www.linkedin.com/in/esteban-pizarro-5897362a9/" target="_blank" className="w-11 hover:scale-110 transition-transform duration-300">
                ...
                <a href="https://www.instagram.com/esteban_pizarro25/" target="_blank" className="w-11 hover:scale-110 transition-transform duration-300">
                ...
                <a href="mailto:pizarroteb06@outlook.com" target="_blank" className="w-11 hover:scale-110 transition-transform duration-300">
