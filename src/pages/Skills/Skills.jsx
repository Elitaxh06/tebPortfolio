                                ...
                                <li className="flex items-center justify-start gap-2 ml-2 text-sm text-slate-200">
                                          <span className="text-cyan-500 w-4 flex text-sm">
                                            <svg
                                              ...
                                              >
                                                <path d="M24 18.588a1.529 1.529 0 01-1.895-.72l-3.45-4.771-.5-.667-4.003 5.444a1.466 1.466 0 01-1.802.708l5.158-6.92-4.                                 798-6. 251a1.595 1.595 0 011.9.666l3.576 4.83 3.596-4.81a1.435 1.435 0 011.788-.668L21.708 7.9l-2.522 3.283a.666.666 0                                  000 .994l4.  804 6.412zM.002 11.576l.42-2.075c1.154-4.103 5.858-5.81 9.094-3.27 1.895 1.489 2.368 3.597 2.275 5.973H1.116C.                             943 16.447 4.   005 19.009 7.92 17.7a4.078 4.078 0 002.582-2.876c.207-.666.548-.78 1.174-.588a5.417 5.417 0 01-2.589 3.                                 957c-2.864 1.607-6. 509.018-8.2-2.779a1.014 1.014 0 01-.296-.725C.038 14.024-.198 12.65.002 11.576zm1.155-.394h9.583a3.026                          3.026 0 00-2.044-2.   906 4.18 4.18 0 00-4.135.599 3.344 3.344 0 00-1.404 2.307z" />
                                              </svg>
                                            </span>
